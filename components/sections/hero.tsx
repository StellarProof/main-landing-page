        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none">
          <div className="space-y-3 sm:space-y-6 text-center px-6 sm:px-8">
            <h1 className="font-semibold">
              ...
              <span className="text-[#06B6D4] text-[clamp(0.95rem,4.5vw,3rem)] block mt-1">ZK proof reusable identity layer for <span className="text-white">Stellar anchor ecosystem</span></span>
            </h1>
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-center pt-2 pointer-events-auto">
                <a href="#waitlist" className="px-6 sm:px-8 py-3 sm:py-4 bg-white/20 text-zinc-300 font-semibold rounded-lg text-base sm:text-lg hover:bg-white/30 transition-colors border border-white/30 backdrop-blur-sm">
                  Join Waitlist
                </a>
                <a href="/about-us" className="px-6 sm:px-8 py-3 sm:py-4 bg-white/20 text-zinc-300 font-semibold rounded-lg text-base sm:text-lg hover:bg-white/30 transition-colors border border-white/30 backdrop-blur-sm">
                  About us
                </a>
              </div>
          </div>
