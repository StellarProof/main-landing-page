...
export function DocTag({
  ...
  return (
    <span
      className="mr-1.5 inline-block rounded-full border px-2.5 py-0.5 text-[11px] font-semibold"
...
export function DocBlock({ children }: { children: React.ReactNode }) {
  return (
    <pre className="my-4 overflow-x-auto rounded-lg border border-white/10 bg-white/[0.03] p-5 font-mono text-[13px] leading-relaxed text-white/80 whitespace-pre">
      {children}
    </pre>
  );
}
